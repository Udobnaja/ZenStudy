...
extension UIView {
  ...
  public func setDimensions(to size: CGSize) {
    setDimension(.width, to: size.width)
    setDimension(.height, to: size.height)
  }
  ...
  public func pinToSuperviewSafeAreaEdge(
    ...
    return pinTo(superviewEdge, of: superview.safeAreaLayoutGuide, with: offset)
  }
  ...
  public func pinEdgesToSuperview(
    ...
    let top = pinEdgeToSuperview(.top, with: insets)
    let leading = pinEdgeToSuperview(.leading, with: insets)
    let bottom = pinEdgeToSuperview(.bottom, with: insets)
    let trailing = pinEdgeToSuperview(.trailing, with: insets)
  ...
  public func pinToSuperviewSafeAreaEdges(
    ...
    let top = pinEdgeToSuperviewSafeArea(.top, with: insets)
    let leading = pinEdgeToSuperviewSafeArea(.leading, with: insets)
    let bottom = pinEdgeToSuperviewSafeArea(.bottom, with: insets)
    let trailing = pinEdgeToSuperviewSafeArea(.trailing, with: insets)
  ...
  public func pinEdgesToSuperviewSafeArea(
    ...
    pinEdgesToSuperviewSafeArea(edges, with: insets)
  }
  ...
  private func pinEdgeToSuperview(
    ...
    return pinToSuperviewEdge(edge, offset: offset)
  }
  ...
  private func pinEdgeToSuperviewSafeArea(
    ...
    let offset = insets.offset(for: edge)
    return pinToSuperviewSafeAreaEdge(edge, offset: offset)
  }
  ...
  private func pinEdgesToSuperviewSafeArea(
    ...
    edges.forEach {
      pinEdgeToSuperviewSafeArea($0, with: insets)
    }
  }
}
...
private extension UIEdgeInsets {
  func offset(for edge: UIView.LayoutEdge) -> CGFloat {
    switch edge {
...
private extension AnchorsProviding {
  func anchor(
